...
import { Menu, X, ChevronRight, Wrench, Zap, Smartphone, CarFrontIcon } from "lucide-react"
...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    if (reduceMotion) {
      // If user prefers reduced motion, mark everything visible (no animations)
    ...
    // IntersectionObserver is lightweight + non-blocking
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            io.unobserve(target) // reveal once for performance
          }
        })
      },
  ...
  return (
    <div ref={rootRef} className="landing-container">
        ...
        <div className="hero-stage">
          ...
          <div className="hero-content" data-reveal>
            ...
            <div className="hero-trust" data-reveal>
              ...
              <div className="trust-pill">Fast Booking</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="services" className="landing-services">
        <div className="services-container">
          ...
          <div className="services-grid">
            {[
              { icon: Wrench, title: "Basic Servicing", desc: "Oil changes, filter replacements, and routine maintenance" },
              ...
              <Link key={idx} href="/auth/login" className="service-card" data-reveal>
                <div className="service-card-inner">
                  <service.icon className="service-icon" />
                  <h3 className="service-title">{service.title}</h3>
                  <p className="service-desc">{service.desc}</p>
                </div>
                {/* UI-only: sheen/highlight layer */}
                <span className="service-sheen" aria-hidden="true" />
              </Link>
            ))}
          </div>
        </div>
        ...
        <div className="about-container">
          ...
          <div className="stats-grid">
            {[
              ...
              <div key={idx} className="stat-card" data-reveal>
      ...
      <section id="download" className="landing-download">
        <div className="download-container" data-reveal>
          <h2 className="download-title">
            <Link href="/auth/login" className="section-title-link">
              Download WHEELS App
            </Link>
          </h2>
          <p className="download-subtitle">Book services, track your vehicle, and get exclusive offers right from your phone.</p>

          <div className="download-buttons" data-reveal>
            <a
